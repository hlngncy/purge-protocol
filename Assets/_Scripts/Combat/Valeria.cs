...
public class Valeria : NetworkBehaviour, IAgent
{
    ...
    public static void OnAgentFired(Changed<Valeria> changed)
    {
    ...
    public static void OnBulletInstance(Changed<Valeria> changed)
    {
